...
<body>
    ...
    //   $sql= "UPDATE members SET name=:name, birthday=:birthday, gender=:gender, =:county, district=:district, zipcode=:zipcode, mobile=:mobile phone=:phone, email=:email, address=:address, updated_at=:updated_at WHERE memberID=:memberID";
    //   $sth = $db ->prepare($sql);
    ...
    //   $sth ->bindParam(":mobile", $_POST['mobile'], PDO::PARAM_INT);
