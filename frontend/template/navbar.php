...
<div id="top">
    <div class="container">
        <div class="col-md-6 offer" data-animate="fadeInDown">
            <a href="register.php" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a> <a href="#">立即取得200元購物金!</a>
        </div>
        <div class="col-md-6" data-animate="fadeInDown">
            <ul class="menu">
                <!-- 登入會員判斷式--如果登入，就會顯示會員名稱，如果未登入就顯示加入會員 -->
                <?php if (isset($_SESSION['member']) && $_SESSION['member'] != null) { ?>
                    <li style="color:#fff;"><?php echo $_SESSION['member']['name']; ?> 您好 <a href="customer-account.php">會員專區</a>
                    </li>
                    <li>
    ...
    <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php foreach ($categories as $product_categories) {  ?>
                                            <a href="product_list.php?category_id=<?php echo $product_categories['product_categoryID']; ?>">
        ...
        <div class="navbar-buttons">
            ...
            <div class="navbar-collapse collapse right" id="basket-overview">
                <a href="basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(<?php if (isset($_SESSION['Cart']) && $_SESSION['Cart'] != null) echo count($_SESSION['Cart']);
                                                                                                                                    else echo "0"; ?>)</span></a>
            </div>
            <!--/.nav-collapse -->
